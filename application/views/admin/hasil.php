<div class="content">
	<h4 style="margin-bottom: 10px; text-align: center;">Uji Kendal</h4>
	<div class="col-md-12" style="margin-bottom: 10px;">
		<form method="GET">
		<div class="row">
			<div class="col-md-5">
		    	<div class="form-group">
			    	<label for="exampleFormControlSelect1">Pilih Tahun ke-1</label>
			    	<?php
			    		$queryTahunPilih = "select distinct tahun from hasil";
			    		$hasilTahunPilih = $this->db->query($queryTahunPilih)->result();
			    	 ?>
				    <select class="form-control" name="tahun1" id="exampleFormControlSelect1">
				    <?php
				...
				<div class="form-group">
			    	<label for="exampleFormControlSelect1">Pilih Tahun ke-2</label>

				    <select class="form-control" name="tahun2" id="exampleFormControlSelect1">
				    <?php
				    foreach ($hasilTahunPilih as $key) {
				    	if ($key->tahun == $tahun) {
				    		$select = "selected";
			    ...
			    <button type="submit" style="margin-top: 10px;" class="btn btn-custom">Laukan Uji</button>
			</div>
			<div class="col-7">
				<?php echo $hasilKendal; ?>
			</div>
		</div>
		</form>
	</div>
	<h4 style="margin-bottom: 10px; text-align: center;">Hasil Metode SAW</h4>
	<br>
	<div class="row">
	<div class="col-md-3">
	<form method="POST" action="<?php echo base_url(); ?>index.php/hasil/">
	    <div class="form-group">
